...
//                    String name = input.getString("Please enter the name of your Grocery Item.").toLowerCase();
//                    String category = input.getString("Please enter the category of the item.").toUpperCase();
//                    int amount = input.getInt("Please enter the amount you wish to purchase.");
////            list[i] = new GroceryItem();
//            input.getString("");
//        }
